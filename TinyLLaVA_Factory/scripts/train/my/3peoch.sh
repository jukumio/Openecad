...
OUTPUT_DIR="/home/kjh/dev/CAD/TinyLLaVA_Factory/newoutputs/Gemma-2.4B-3epoch"

deepspeed --include localhost:2,3 --master_port 29502 /home/kjh/dev/CAD/TinyLLaVA_Factory/tinyllava/train/custom_finetune.py \
