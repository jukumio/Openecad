...
deepspeed --include localhost:0,1,2,3,4,5,6,7 --master_port 29501 tinyllava/train/train.py \
    ...
    --pretrained_model_path /home/kjh/TinyLLaVA_Factory/tinyllava-${LLM_VARIANT}-${VT_VARIANT}-${VERSION}-pretrain \
    --output_dir /home/kjh/TinyLLaVA_Factory/tinyllava-${LLM_VARIANT}-${VT_VARIANT}-${VERSION}-finetune \
    --num_train_epochs 1 \
