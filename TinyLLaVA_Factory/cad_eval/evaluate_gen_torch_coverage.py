...
from DeepCAD.utils.pc_utils import read_ply

N_POINTS = 15

random.seed(1234)

PC_ROOT = "/home/kjh/dev/CAD/TinyLLaVA_Factory/dataset/FREECADVIEW/pc"
...
def collect_test_set_pcs(args):
    ...
    print(len(all_data))
    select_num = min(args.n_test + 5, len(all_data))
    select_idx = random.sample(list(range(len(all_data))), select_num)
